	...
	public static void main(String[] args) {
		...
		try {
			...
			ObjectOutputStream oos 
				= new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("d:/D_Other/memObj.bin")));
			...
			Object obj = null;
				...
				while((obj = ois.readObject()) != null) {	//역직렬화 이루어짐
